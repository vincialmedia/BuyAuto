  ...
  return (
    <div className="bg-[#fafafa] min-h-screen font-sans overflow-x-hidden">
      <Head>
        ...
        <meta property="og:image" content="https://www.buyauto.ch/buyauto-logo.png" />
        ...
        <meta
          ...
          content="Auto kaufen in der Schweiz – Occasionen, Neuwagen, Leasing, Auto-Abo & Leasingübernahmen auf einer Plattform. Finde jetzt dein passendes Auto mit BuyAuto."
        />
        <meta name="twitter:image" content="https://www.buyauto.ch/buyauto-logo.png" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/inserat-erstellen">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-neutral-600 text-white hover:border-white hover:bg-white/10 font-bold rounded-xl px-10 h-14 w-full sm:w-auto hover:scale-105 transition-all duration-300"
              >
                Inserat erstellen
              </Button>
            </Link>
