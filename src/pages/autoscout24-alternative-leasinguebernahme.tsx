...
export const getStaticProps = staticI18nProps(["pages/autoscout24-alternative-leasinguebernahme"]);
...
export default function AutoscoutAlternativeLeasinguebernahmePage() {
        ...
        "itemListElement": [
          {
            ...
            "position": 1,
            "name": t("Home"),
            // Historical German value has no trailing slash — keep it byte-identical.
            "item": absoluteUrl("/", locale).replace(/\/$/, "")
          },
          {
            "@type": "ListItem",
            "position": 2,
            "name": t("Leasingübernahme"),
            "item": absoluteUrl("/leasinguebernahme", locale)
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": t("Alternative zu AutoScout24"),
            "item": absoluteUrl("/autoscout24-alternative-leasinguebernahme", locale)
          }
        ]
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": t("Muss der Leasinggeber einer Leasingübernahme zustimmen?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Ja, der Leasinggeber (die Bank) muss der Übernahme zustimmen. Er prüft in der Regel die Bonität des neuen Leasingnehmers.")
            }
          },
          {
            "@type": "Question",
            "name": t("Wird eine Bonitätsprüfung gemacht?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Ja, absolut. Der neue Leasingnehmer übernimmt die finanziellen Verpflichtungen, daher prüft die Bank dessen Zahlungsfähigkeit.")
            }
          },
          {
            "@type": "Question",
            "name": t("Welche Kosten entstehen bei einer Leasingübernahme?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Meistens fällt eine Umschreibegebühr der Bank an (ca. CHF 300–600). Diese ist oft deutlich geringer als die Kosten einer vorzeitigen Vertragskündigung.")
            }
          },
          {
            "@type": "Question",
            "name": t("Wie lange dauert eine Leasingübernahme?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Sobald ein Nachfolger gefunden ist und die Unterlagen vollständig eingereicht sind, dauert die Prüfung durch die Bank oft nur wenige Tage bis eine Woche.")
            }
          },
          {
            "@type": "Question",
            "name": t("Kann ich mein Leasing-Auto einfach verkaufen?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Nein, da das Auto der Bank gehört, kannst du es nicht einfach verkaufen. Du müsstest es erst aus dem Vertrag herauskaufen (was teuer ist) oder eben den Leasingvertrag übertragen.")
            }
          },
          {
            "@type": "Question",
            "name": t("Welche Angaben gehören ins Inserat, damit es schneller geht?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Wichtig sind: Monatliche Rate, Restlaufzeit, aktuelle Kilometer, Restkilometer, Anzahlung (falls gewünscht) und der Name der Leasingbank.")
            }
          },
          {
            "@type": "Question",
            "name": t("Was passiert nach der Bewilligung?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Die Bank erstellt einen Umschreibungsvertrag. Wenn beide Parteien unterschrieben haben, kann das Fahrzeug übergeben werden.")
            }
          },
          {
            "@type": "Question",
            "name": t("Worauf sollte man bei der Fahrzeugübergabe achten?"),
            "acceptedAnswer": {
              "@type": "Answer",
              "text": t("Erstellt unbedingt ein Übergabeprotokoll, haltet den genauen Zustand und Kilometerstand fest und übergebt alle Schlüssel und Dokumente.")
            }
          }
        ]
      }
  ...
  return (
    <>
      <Head>
        <title>{t("Alternative zu AutoScout24 für Leasingübernahmen | BuyAuto")}</title>
        <meta
          name="description"
          content={t("BuyAuto ist auf Leasingübernahmen spezialisiert: Inserat in Minuten erstellen, relevante Leasingdaten klar sichtbar, fairer Ablauf. Jetzt Leasing abgeben/übernehmen.")}
        />
        <link rel="canonical" href={absoluteUrl("/autoscout24-alternative-leasinguebernahme", locale)} />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Article",
              headline: t("Die Alternative zu AutoScout24 für Leasingübernahmen"),
              ...
              mainEntityOfPage: absoluteUrl("/autoscout24-alternative-leasinguebernahme", locale),
            }),
          }}
        />
        
        {/* Open Graph */}
        <meta property="og:title" content={t("Alternative zu AutoScout24 für Leasingübernahmen | BuyAuto")} />
        <meta property="og:description" content={t("BuyAuto ist auf Leasingübernahmen spezialisiert: Inserat in Minuten erstellen, relevante Leasingdaten klar sichtbar, fairer Ablauf.")} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={absoluteUrl("/autoscout24-alternative-leasinguebernahme", locale)} />
      ...
      <main className={`bg-white min-h-screen ${showStickyCTA ? "pb-28 md:pb-0" : ""}`}>
            ...
            <div className="max-w-7xl mx-auto px-4 py-4">
              <div className="flex items-center justify-between gap-4">
                <div className="hidden md:block">
                  <p className="text-white font-bold text-lg">{t("Spezialisiert auf Leasingübernahmen")}</p>
                  <p className="text-white/80 text-sm">{t("Die moderne Alternative")}</p>
                </div>
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0">
              <Image
                ...
                alt={t("Handshake - Leasing Übernahme")}
                fill
            ...
            <div className="max-w-6xl mx-auto">
              <div className="max-w-3xl">
                <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-semibold mb-6 border border-primary/20 backdrop-blur-sm">
                  ...
                  {t("Der Spezialist für Leasingübernahmen · Aktualisiert am {date}", { date: formatSwissDate(LAST_UPDATED_ISO) })}
                </div>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-neutral-900 tracking-tight leading-[1.1] mb-6">
                  <T k="Die Alternative zu AutoScout24 für <0>Leasingübernahmen</0>" c={[<span key="0" className="text-primary" />]} />
                </h1>
                <p className="text-xl md:text-2xl text-neutral-600 font-medium mb-8 leading-relaxed">
                  <T
                    k="AutoScout24 ist top, wenn du ein Auto suchst. Wenn du aber dein <0>Leasing loswerden</0> willst, ist BuyAuto die spezialisierte Alternative: Monatsrate, Restlaufzeit und Kilometer stehen bei jedem Inserat sofort sichtbar, und Interessenten suchen hier gezielt nach Übernahmen. So findest du schneller jemanden, der deinen Vertrag wirklich übernehmen will."
                    c={[<Link key="0" href="/leasing-abgeben-schweiz" className="text-primary hover:underline underline-offset-4 decoration-primary/30" />]}
                  />
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  >
                    <Link href="/inserat-erstellen">
                      {t("Leasing abgeben (Inserat erstellen)")}
                ...
                <div className="flex items-center gap-2 text-sm text-neutral-500 font-medium">
                  ...
                  <span>{t("Leasingübernahmen benötigen in der Regel die Zustimmung des Leasinggebers und oft eine Bonitätsprüfung – wir zeigen dir den Ablauf klar und transparent.")}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-black text-neutral-900 mb-8">
              {t("Warum viele für Leasingübernahmen etwas anderes suchen")}
            </h2>
            <div className="bg-neutral-50 rounded-3xl p-8 md:p-12 border border-neutral-200 shadow-sm">
              <p className="text-xl md:text-2xl text-neutral-700 font-medium leading-relaxed mb-8">
                <T
                  k={"\"Auf einem riesigen Marktplatz geht die <0>Leasingübernahme</0> oft unter. Du willst nicht durch 'Top Occasion!' scrollen, nur um am Ende eine Anzeige zu finden, bei der irgendwo steht: <1>'Leasing kann evtl. übernommen werden.'</1>\""}
                  c={[
                    <Link key="0" href="/leasinguebernahme" className="text-primary hover:underline underline-offset-4 decoration-primary/30" />,
                    <span key="1" className="italic text-neutral-500" />,
                  ]}
                />
              </p>
              <div className="inline-flex items-center gap-3 bg-white px-6 py-3 rounded-xl border border-neutral-200 shadow-sm">
                ...
                <span className="font-bold text-neutral-900">{t("Darum gibt’s BuyAuto: Leasingübernahmen als Hauptgericht, nicht als Beilage.")}</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-neutral-900 mb-4">
                {t("Was BuyAuto als Alternative besser löst")}
              </h2>
            </div>
        ...
        <section id="ablauf" className="py-20 px-4 bg-white scroll-mt-20">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black text-neutral-900 mb-4">
                {t("So funktioniert eine Leasingübernahme")}
              </h2>
              <p className="text-neutral-600 text-lg">{t("In 5 einfachen Schritten in der Schweiz")}</p>
            </div>
                    ...
                    <div className="flex items-start gap-6 md:gap-8">
                      ...
                      <div className="flex-1 min-w-0 bg-neutral-50 rounded-3xl p-8 border-2 border-neutral-100 hover:border-primary/30 transition-all duration-300 hover:shadow-lg group">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <h3 className="min-w-0 text-xl md:text-2xl font-black text-neutral-900">{t(item.title)}</h3>
                        </div>
                        <p className="text-neutral-600 text-lg">
                          {item.step === 4 ? (
                            <T
                              k="Der <0>Umschreibungsvertrag</0> wird von allen Parteien unterzeichnet."
                              c={[<Link key="0" href="/leasingvertrag-uebertragen" className="text-primary hover:underline underline-offset-4" />]}
                            />
                          ) : t(item.desc)}
                        </p>
                      </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1">
                  <p className="text-xl text-neutral-700 leading-relaxed mb-6">
                    <T
                      k="Oft fallen Gebühren für die Umschreibung/Übertragung an. Die genaue Höhe hängt vom Leasinggeber ab (oft zwischen CHF 300 und CHF 600) – eine detaillierte Aufschlüsselung, <0>was eine Leasingübernahme kostet</0>, findest du in unserem Kosten-Ratgeber."
                      c={[<Link key="0" href="/leasinguebernahme-kosten" className="text-primary hover:underline underline-offset-4 decoration-primary/30" />]}
                    />
                  </p>
                  <p className="text-xl text-neutral-700 leading-relaxed font-medium">
                    <T
                      k='Im Vergleich zu <0>"vorzeitig kündigen und alles zahlen"</0> ist die Übernahme für viele der deutlich sinnvollere und günstigere Exit.'
                      c={[<span key="0" className="text-red-600" />]}
                    />
                  </p>
                </div>
                <div className="w-full md:w-1/3 bg-primary/5 border-2 border-primary/20 rounded-2xl p-6 text-center">
                  ...
                  <p className="font-bold text-neutral-900 mb-2">{t("Pro-Tipp:")}</p>
                  <p className="text-sm text-neutral-600">
                    {t("Je vollständiger die Angaben im Inserat, desto schneller geht’s.")}
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-4 bg-neutral-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black text-neutral-900 mb-4">
                {t("BuyAuto vs. AutoScout24")}
              </h2>
              <p className="text-neutral-600 text-lg">{t("Ein fairer Vergleich für Leasingübernahmen")}</p>
            </div>
              ...
              <Card className="border-2 border-neutral-200 rounded-3xl overflow-hidden hover:shadow-lg transition-shadow">
                <CardContent className="p-0">
                  <div className="bg-neutral-100 p-8 border-b border-neutral-200">
                    ...
                    <p className="text-neutral-500 font-medium">{t("Der Platzhirsch für Alles")}</p>
                  </div>
                  <div className="p-8 bg-white h-full">
                    <p className="font-bold text-neutral-900 mb-4 text-lg">{t("Stark, wenn...")}</p>
                    <ul className="space-y-4">
                      <li className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-neutral-400 mt-0.5 shrink-0" />
                        <span className="text-neutral-600">{t("du ein Auto kaufen oder verkaufen willst.")}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-neutral-400 mt-0.5 shrink-0" />
                        <span className="text-neutral-600">{t("du maximale Reichweite für Occasionen suchst.")}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <Check className="w-5 h-5 text-neutral-400 mt-0.5 shrink-0" />
                        <span className="text-neutral-600">{t("Leasingübernahme nur eine Option unter vielen ist.")}</span>
                      </li>
                    </ul>
                  </div>
                </CardContent>
              ...
              <Card className="border-2 border-primary/20 rounded-3xl overflow-hidden shadow-xl ring-4 ring-primary/5">
                <CardContent className="p-0">
                  <div className="bg-gradient-to-r from-primary to-primary/90 p-8 border-b border-primary/20">
                    ...
                    <p className="text-white/80 font-medium">{t("Der Spezialist für Leasing")}</p>
                  </div>
                  <div className="p-8 bg-white h-full">
                    <p className="font-bold text-neutral-900 mb-4 text-lg">{t("Stärker, wenn...")}</p>
                    <ul className="space-y-4">
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 shrink-0" />
                        <span className="text-neutral-900 font-medium">{t("du gezielt ein Leasing abgeben oder übernehmen willst.")}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 shrink-0" />
                        <span className="text-neutral-900 font-medium">{t("Leasingdaten (Rate, KM, Laufzeit) sofort sichtbar sein müssen.")}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 shrink-0" />
                        <span className="text-neutral-900 font-medium">{t("du eine transparente, spezialisierte Plattform suchst.")}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 shrink-0" />
                        <span className="text-neutral-900 font-medium">{t("du nicht in der Masse untergehen willst.")}</span>
                      </li>
                    </ul>
                  </div>
                </CardContent>
            ...
            <div className="mt-12 text-center bg-primary/5 rounded-2xl p-6 border border-primary/10 mx-auto max-w-3xl">
              <p className="text-lg text-neutral-700 font-medium">
                <T
                  k={"\"Wenn du Leasingübernahme suchst, willst du kein 'Marktplatz mit Leasing-Option irgendwo im Text'. Du willst Leasingübernahme als Fokus.\" Genau dafür gibt es die <0>Leasingübernahme-Angebote auf BuyAuto</0> – gefiltert, vergleichbar, ohne Umwege."}
                  c={[<Link key="0" href="/suche?dealType=lease_takeover" className="text-primary hover:underline underline-offset-4 decoration-primary/30" />]}
                />
              </p>
            </div>
          </div>
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-start gap-4">
                    ...
                    <span className="text-lg text-neutral-700 font-medium">{t(item)}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="flex-1 text-center md:text-left">
                <h2 className="text-3xl font-black mb-6">{t("Über BuyAuto")}</h2>
                <div className="space-y-4 text-neutral-300 text-lg leading-relaxed">
                  <p>
                    {t('"BuyAuto habe ich gebaut, weil ich selbst mein Leasing abgeben wollte – und keine Plattform in der Schweiz gefunden habe, die modern, benutzerfreundlich und klar auf Leasingübernahmen ausgerichtet ist. Also habe ich eine gebaut."')}
                  </p>
                  <p>
                    {t("BuyAuto wurde von VincialMedia, meiner eigenen Agentur, entwickelt. Wir bauen digitale Produkte, die echte Probleme lösen – und BuyAuto ist genau so entstanden: aus echter Erfahrung, nicht aus PowerPoint.")}
                  </p>
                </div>
                <div className="mt-8 pt-8 border-t border-neutral-800">
                  <p className="font-bold text-white text-xl">— Vincent Hänggi</p>
                  <p className="text-primary/80">{t("Gründer von BuyAuto")}</p>
                </div>
              </div>
            </div>
            <div className="mt-16 text-center">
              <p className="text-xs text-neutral-500 uppercase tracking-widest">
                {t("Hinweis: BuyAuto ist eine unabhängige Plattform und steht in keiner offiziellen Verbindung zu AutoScout24.")}
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="faq" className="py-20 px-4 bg-white scroll-mt-20">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-600 text-lg">{t("Alles zur Leasingübernahme")}</p>
            </div>
        ...
        <section className="py-24 bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 px-4 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
              <Sparkles className="w-4 h-4" />
              {t("Bereit für den Wechsel?")}
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-white leading-tight">
              <T
                k="Die spezialisierte Alternative<0/><1>für Leasingübernahmen</1>"
                c={[<br key="0" />, <span key="1" className="text-primary" />]}
              />
            </h2>
            <p className="text-neutral-300 max-w-2xl mx-auto text-xl leading-relaxed">
              {t("Erstelle jetzt dein Inserat auf der Plattform, die Leasing versteht.")}
            </p>
            ...
            <div className="pt-12 flex flex-wrap items-center justify-center gap-8 text-neutral-400 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>{t("100% spezialisiert")}</span>
              </div>
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-5 h-5 text-green-400" />
                <span>{t("Sicher & transparent")}</span>
              </div>
              <div className="flex items-center gap-2">
                <Eye className="w-5 h-5 text-green-400" />
                <span>{t("Klare Daten")}</span>
              </div>
            </div>
          </div>
        </section>
