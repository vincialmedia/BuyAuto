...
// that phrase as an internal link without duplicating the copy. The same holds
// for their translations in src/i18n/messages/<locale>/pages/fuer-garagen.json.
// `vars` fills the {placeholders} of `a` (the German text is the i18n key).
type Faq = { q: string; a: string; vars?: TranslateVars; href?: string; linkText?: string };
...
const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: "Garagen-Inserate sind an dein Monatspaket gebunden: Sie bleiben online, solange dein Paket aktiv ist – das Paket begrenzt nur die Anzahl gleichzeitig aktiver Inserate. Private Inserate laufen je nach Plan {standardDays} Tage, {extendedDays} Tage oder unlimitiert bis zum Verkauf. Details auf der Preisseite.",
    vars: {
...
export default function FuerGaragen() {
  ...
  return (
    <>
      <Head>
        <title>{t("BuyAuto für Garagen – Leasingübernahme als Verkaufschance")}</title>
        <meta
          name="description"
          content={t(
            "Ein Kunde steckt im Leasing und der Eintausch scheitert? Inseriere den Vertrag zur Übernahme auf BuyAuto – und mach den Weg frei für den nächsten Verkauf."
          )}
        />
        <link rel="canonical" href={absoluteUrl("/fuer-garagen", locale)} />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              mainEntity: FAQS.map((faq) => ({
                "@type": "Question",
                name: t(faq.q),
                acceptedAnswer: { "@type": "Answer", text: t(faq.a, faq.vars) },
              })),
            }),
          }}
        />
        ...
        {/* Open Graph */}
        <meta property="og:title" content={t("BuyAuto für Garagen – Leasingübernahme als Verkaufschance")} />
        <meta
        ...
        <meta property="og:url" content={absoluteUrl("/fuer-garagen", locale)} />
      </Head>
      ...
      <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          <Breadcrumbs
            items={[
              { name: t("Home"), href: "/" },
              { name: t("Für Garagen"), href: "/fuer-garagen" },
            ]}
          />
        </div>
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-neutral-900 tracking-tight leading-[1.05] mb-6">
              <T k="Wenn das Leasing deinen <0>Verkauf blockiert</0>" c={[<span key="accent" className="text-red-500" />]} />
            </h1>
            ...
            <p className="text-lg sm:text-xl text-neutral-600 leading-relaxed max-w-3xl">
              {t(
                "Ein Kunde will bei dir kaufen – aber sein laufender Leasingvertrag steht im Weg. Die vorzeitige Auflösung ist teuer, der Eintausch rechnet sich nicht, und der Deal stirbt. BuyAuto löst genau dieses Problem: Der bestehende Vertrag wird zur Übernahme inseriert, eine geprüfte Übernehmerin oder ein geprüfter Übernehmer tritt ein – und dein Kunde ist frei für den nächsten Kauf bei dir."
              )}
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              >
                ...
                <a href={`mailto:hello@buyauto.ch?subject=${encodeURIComponent(t("Frage von unserer Garage"))}`}>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-neutral-50">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 tracking-tight mb-10 text-center">
              {t("So nutzt du BuyAuto als Garage")}
            </h2>
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {STEPS.map((item) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-neutral-900 mb-3">{t(item.title)}</h3>
                  <p className="text-neutral-600 leading-relaxed">{t(item.text)}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 tracking-tight mb-10 text-center">
              {t("Was BuyAuto deiner Garage bringt")}
            </h2>
            <div className="grid sm:grid-cols-2 gap-6">
              {BENEFITS.map((benefit) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-neutral-900 mb-1.5">{t(benefit.title)}</h3>
                    <p className="text-neutral-600 leading-relaxed">
                      {withInlineLink(t(benefit.text), benefit.href, benefit.linkText && t(benefit.linkText))}
                    </p>
                  </div>
                </div>
              ))}
              ...
              {FAQS.map((faq, index) => (
                ...
                >
                  ...
                  <AccordionContent className="text-neutral-600 leading-relaxed pb-5 text-base">
                    {withInlineLink(t(faq.a, faq.vars), faq.href, faq.linkText && t(faq.linkText))}
                  </AccordionContent>
                </AccordionItem>
              ))}
            </Accordion>
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-neutral-900">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4 tracking-tight">
              {t("Mach blockierte Deals wieder abschlussfähig")}
            </h2>
            <p className="text-lg text-neutral-300 mb-8 max-w-2xl mx-auto">
              {t("Inseriere den Leasingvertrag deines Kunden zur Übernahme – oder stell uns zuerst deine Fragen.")}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
              ...
              >
                <a href={`mailto:hello@buyauto.ch?subject=${encodeURIComponent(t("Frage von unserer Garage"))}`}>{t("Frage stellen")}</a>
              </Button>
            </div>
            <p className="mt-8 text-sm text-neutral-400">
              {t("Mehr zur Übertragung:")}{" "}
...
export const getStaticProps = staticI18nProps(["pages/fuer-garagen"]);
