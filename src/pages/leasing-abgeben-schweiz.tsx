...
// Single source for the Article dateModified in the page's structured data.
...
export default function LeasingAbgebenSchweiz({ takeoverListings }: LeasingAbgebenPageProps) {
  ...
  return (
    <>
      ...
      {/* No visible crumb bar (the funnel layout has no room for it), but the
          BreadcrumbList structured data keeps the cluster hierarchy for search. */}
      <BreadcrumbJsonLd
        items={[
          { name: "Home", href: "/" },
