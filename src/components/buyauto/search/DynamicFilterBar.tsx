      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="min-w-0 flex-1">
          <Input
            ...
            onChange={(e) => onSearchQueryChange({ ...searchQuery, brand: e.target.value || undefined })}
        ...
        <div className="min-w-0 flex-1">
          <Input
            ...
            onChange={(e) => onSearchQueryChange({ ...searchQuery, model: e.target.value || undefined })}
            className="h-8 text-xs border-neutral-300/60 bg-white/80 focus:border-red-500 focus:ring-0"
          />
        </div>
        ...
        <div className="min-w-0 w-32">
          <Select
            value={searchQuery.sort || "price_asc"}
            onValueChange={(value) => onSearchQueryChange({ 
              ...searchQuery, 
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="year_desc">Neueste</SelectItem>
              <SelectItem value="months_asc">Kurze Laufzeit</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
