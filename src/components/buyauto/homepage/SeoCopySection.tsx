        ...
        <article className="prose prose-neutral max-w-none">
            ...
            {isExpanded && (
              <>
                ...
                <p>
                  ...
                  <Link href="/suche" className="text-red-600 hover:underline">
                ...
                <p>
                  ...
                  <Link href="/inserat-erstellen" className="text-red-600 hover:underline">
                    kostenloses Inserat
                  </Link>{" "}
          ...
          <div className="mt-8 text-center">
            <Button
              ...
              className="inline-flex items-center gap-2 h-11 px-6 rounded-xl font-medium border-neutral-300 hover:border-neutral-400 transition-colors"
            >
