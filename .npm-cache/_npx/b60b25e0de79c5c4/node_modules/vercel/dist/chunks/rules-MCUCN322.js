...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-GRDKWPVP.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-GRDKWPVP.js")).default(client, args);
    case "add":
      return (await import("./add-HLIPDOM3.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-GW54LGXF.js")).default(client, args);
    case "rm":
      return (await import("./rm-EDOGYDVM.js")).default(client, args);
    case "update":
      return (await import("./update-QHI4MJ6N.js")).default(client, args);
    default:
